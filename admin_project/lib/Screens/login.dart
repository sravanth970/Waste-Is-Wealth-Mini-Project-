...
import 'package:admin_project/Screens/forgotpassword.dart';
import 'package:admin_project/Screens/register.dart';
        ...
        children: [
          Stack(
            children: [
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(250.0, 130.0, 0.0, 0.0),
                child: const Text(
                  '!',
                  style: TextStyle(
                    fontSize: 80.0,
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (BuildContext context) {
                              return const AdminForgotPassword();
                            },
                          ),
                        );
                      },
